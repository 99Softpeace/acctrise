        ...
        <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/90 px-4 py-3 backdrop-blur sm:px-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <span className="grid h-10 w-10 place-items-center overflow-hidden rounded-lg bg-blue-50 ring-1 ring-blue-100 lg:hidden">
                <Image src="/acctrise-logo.jpeg" alt="Acctrise" width={40} height={40} className="h-full w-full object-cover" />
              </span>
              <div>
                <p className="text-xs font-bold uppercase tracking-[0.18em] text-blue-600">Dashboard</p>
                <h1 className="text-xl font-bold tracking-tight text-slate-800 sm:text-2xl">Welcome back</h1>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <button className="inline-flex h-10 items-center gap-2 rounded-lg border border-red-100 px-3 text-sm font-bold text-red-600 transition hover:bg-red-50 lg:hidden" onClick={handleLogout} type="button" aria-label="Logout">
              ...
              return (
                <Link
                  ...
                  className={`inline-flex h-10 shrink-0 items-center gap-2 rounded-lg px-3 text-xs font-bold ring-1 ${
                    active
                      ? "bg-blue-600 text-blue-50 ring-blue-600"
